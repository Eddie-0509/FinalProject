					...
					<div class="formcontainer">
						<div class="containerF">
							...
							<label for="clinicAccount"><strong>電子信箱</strong></label><span id="checkEmail"></span> 
								...
								<input type="password" placeholder="請輸入密碼(含英文字母與標點符號)" name="memberPwd" id="clinicPwd" required>
								<label for="clinicPwdCheck"><strong>確認密碼</strong></label><span id="spPwdCheck"></span>
								<input type="password" placeholder="請再次輸入密碼(含英文字母與標點符號)" name="memberPwdCheck" id="clinicPwdCheck" required>
								<label for="clinicName"><strong>會員名稱</strong></label> 
								<input type="text" placeholder="請輸入名稱" name="memberName" id="clinicName"> 
								<label for="clinicPhone"><strong>會員電話</strong></label><span id="checkPhone"></span> 
								<input type="text" name="memberPhone" id="clinicPhone" placeholder="0912345678"><br> 
								<label for="idcMember"><strong>身分證字號</strong></label><span id="idMember"></span> 
								<input type="text" name="memberIdNumber" id="idcMember" placeholder="例如:C121601118"><br> 
...
<!-- 							</div> -->
							...
							<label for="clinicAddress"><strong>地址</strong></label> <br><input
								type="text" name="memberAddress" id="clinicAddress">
					...
					.blur(
							function() {
								...
								if (phoneVal == "") {
									...
									span
											.html("&nbsp &nbsp <i class='fas fa-exclamation-circle'></i>請輸入正確電話號碼 ex.就是錯在這");
									flagPhone = false;
								} else {
									span.html("");
									flagPhone = true;
