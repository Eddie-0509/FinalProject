						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<form class="loginForm"
									action="${pageContext.request.contextPath}/appointmentCheckLogin" method="POST">
									<h1>一般會員</h1>
									<div class="usericon">
									...
									<div class="choose">
										...
										<a href="<c:url value='/member'/>" class="sign">
											<h2>註　冊</h2>
										</a>
									</div>
									<div class="formcontainer">
										<div class="container">
											...
											<input type="text" placeholder="請輸入身分證字號" name="account" id="uname" required
												autofocus>
										...
										<input type="hidden" name="memberappointdate" value="" id="mappointdate" />
