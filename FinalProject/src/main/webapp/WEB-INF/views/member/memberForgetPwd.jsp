...
<body>
	...
	<div id="fh5co-page">
		...
		<div class="js-fh5co-waypoint fh5co-project-detail" id="fh5co-main"
			...
			<form action="memberForgotPwdForm" id="memberForgotPwdForm" method="post">
			<div>
			<strong>立即發送重設密碼Email至您的信箱</strong>
			</div>
			<br>
			<div>
			<label for="memberAccount">請輸入Email帳號:</label>
			<input style= "color:black" type="text" name="memberAccount" id="memberAccount" placeholder="請輸入Email帳號">
			<span id="memberCheckAccount"></span>
			</div>
			<br>
	...
	$(function(){
		...
		$("#memberAccount").blur(function() {
					let emailVal = $("#memberAccount").val();
					let span = $("#memberCheckAccount");
					let flag1 = false;
					$("#memberCheckAccount").css("color", "red");
					if (emailVal == "") {
						span
