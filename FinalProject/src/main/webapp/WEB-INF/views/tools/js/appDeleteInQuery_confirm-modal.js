  ...
  question() {
    return new Promise((resolve, reject) => {
      ...
      this.acceptButton.addEventListener("click", () => {
        resolve(true);
//        $("#deleteFormInputInQ").val(appointmentID);
		$("#deleteAppointmentFormInQ").trigger("submit");
//        this._destroyModal();
      });
  ...
  _createModal() {
    ...
    form.type = "form";
    form.action = "/FinalProject/deleteAppointment"
    form.id = "deleteAppointmentFormInQ";
    form.method = "POST";
    form.classList.add('simple-modal-form');
    ...
    buttonGroup.appendChild(form);
    form.appendChild(this.acceptButton);
    const input = document.createElement('input');
    input.type = "input";
    input.name = "appointmentPkId";
    input.hidden = "hidden";
    input.id = "deleteFormInputInQ";
